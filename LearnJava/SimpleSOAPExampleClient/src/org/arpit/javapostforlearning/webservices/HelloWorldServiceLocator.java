...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements org.arpit.javapostforlearning.webservices.HelloWorldService {
    ...
    public org.arpit.javapostforlearning.webservices.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.arpit.javapostforlearning.webservices.HelloWorldSoapBindingStub _stub = new org.arpit.javapostforlearning.webservices.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.arpit.javapostforlearning.webservices.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                org.arpit.javapostforlearning.webservices.HelloWorldSoapBindingStub _stub = new org.arpit.javapostforlearning.webservices.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.javapostforlearning.arpit.org", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.javapostforlearning.arpit.org", "HelloWorld"));
        }
