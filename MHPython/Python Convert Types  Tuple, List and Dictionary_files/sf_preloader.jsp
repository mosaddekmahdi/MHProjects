...
//                window.console.log("catch " + ex);
    ...
    blacklistHandler: blacklistHandler = function()
    {
        ...
        var pageBlackList = "|www.ebay.com|www.zappos.com|www.gap.com|www.victoriassecret.com|";
...
//{
//	"tier1":{"bucket":null,"group":-1,"nextGroup":-1,"previousGroup":-1},
//	"tier2":{"bucket":null,"group":-1,"nextGroup":-1,"previousGroup":-1},
//	"userId":"6ecbaefb-75ff-73b0-0a98-1c02f6330b15-4bb"
//}        

//        if (window.console) console.log("setValues  " + window.location.href);
//        if (window.console) console.log(obj);
        if (obj) {
            if (obj.tier1) {
//                dataObj.tier1_bucket = (obj.tier1.bucket || "") === "" ? "" : ((similarproducts.b.qsObj && similarproducts.b.qsObj.bucket ) || (window.qsObj && window.qsObj.bucket )) || obj.tier1.bucket;
            ...
            if (obj.tier2) {
//                dataObj.tier2_bucket = ((obj.tier2.bucket || "") === "" && dataObj.tier1_bucket !== "") ? "" :  ((similarproducts.b.qsObj && similarproducts.b.qsObj.bucket ) || (window.qsObj && window.qsObj.bucket )) || obj.tier2.bucket;
...
//        if (window.console) console.log(dataObj);
    }
...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!similarproducts.b.qsObj.dlsource) {
            similarproducts.b.qsObj.dlsource = "pcom";
        }
